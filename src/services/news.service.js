...
export const likeNewsServices = (idNews, userId) => News.findOneAndUpdate({_id: idNews, "likes.userId": {$nin: [userId]}},{$push: {likes: {userId, created: new Date()}}});

export const deleteLikeNewsServices = (idNews, userId) => News.findOneAndUpdate({ _id: idNews},{$pull: {likes: {userId } } });